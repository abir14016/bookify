...
const AddBook = () => {
  ...
  return (
    <div className="md:flex justify-center items-center px-2 md:px-8 lg:px-64 h-screen">
      {/* <div> */}
              ...
              <div>
                ...
                <div className="form-control w-full max-w-xs">
                  ...
                  <input
                    ...
                    className="input input-disabled text-blue-400 input-bordered w-full max-w-xs"
                    {...register("owner", {
                      required: {
                        value: true,
